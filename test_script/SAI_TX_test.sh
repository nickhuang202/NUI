...
if [ "$ZST_VER" == "" ];then
	...
	echo "Usage: ./SAI_TX_test.sh <zst_version> [test_level]"
	echo "Example: ./SAI_TX_test.sh $BIN t0"
	echo "         ./SAI_TX_test.sh $BIN t1"
	echo "         ./SAI_TX_test.sh $BIN t2"
	echo ""
...
#SAI TEST
LINK_TEST_LOG="${TEST_LEVEL}_sai_test_${ZST_VER}_${DATE}.log"
...
echo "========================================================================"
echo "Starting SAI ${TEST_LEVEL^^} Test"
echo "========================================================================"
...
echo ""
echo "========================================================================"
echo "SAI ${TEST_LEVEL^^} Test completed"
...
FINAL_ARCHIVE="SAI_${TEST_LEVEL}_${DETECTED_PLATFORM}_${ZST_VER}_${DATE}.tar.gz"
